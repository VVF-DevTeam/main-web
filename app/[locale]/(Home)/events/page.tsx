...
const EventsPage = async({ params }: { params: Promise<{ locale: string }> }) => {
  const eventList = [
    ...
    },
    {
      ...
      description: 'asdsad',
      eventCategoryId: '1',
      thumbnail: 'https://drive.google.com/thumbnail?id=1QD6S776uzQnAIZ2zW7OwPjXUCPWI1jxv&sz=w1000',
    ...
    },
    {
      ...
      description: 'asdsad',
      eventCategoryId: '1',
      thumbnail: 'https://drive.google.com/thumbnail?id=1HsFliVn1V3lBc3yMhFlOPG629zOj83Lg&sz=w1000',
