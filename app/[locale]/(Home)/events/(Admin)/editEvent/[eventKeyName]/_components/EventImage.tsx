...
type EventImageFormValues = z.infer<typeof EventImageSchema>
...
const EventImage = ({ event }: EventImageProps) => {
  ...
  const handleEventImageUpload =
    (fieldPath: Path<EventImageFormValues>) =>
    async (eventChange: React.ChangeEvent<HTMLInputElement>) => {
      if (!eventChange.target.files?.[0]) return
                    ...
                    <FormItem className="w-full">
                      <FormControl>
                        <div className="space-y-3">
                          ...
                          <ImageUploadButton
                            onChange={handleEventImageUpload('imgUrl')}
                        ...
                        <FormItem className="w-full">
                          <FormControl>
                            <div className="space-y-3">
                              ...
                              <ImageUploadButton
                                onChange={handleEventImageUpload('subImgUrls.0')}
                                disabled={isLoading || isSubmitting}
                              />
                            </div>
                          </FormControl>
                        ...
                        <FormItem className="w-full">
                          <FormControl>
                            <div className="space-y-3">
                              ...
                              <ImageUploadButton
                                onChange={handleEventImageUpload('subImgUrls.1')}
                                disabled={isLoading || isSubmitting}
                              />
                            </div>
                          </FormControl>
