    ...
    <div className="flex-center">
      <div className="flex-col-center width-max-default default-gap p-12">
        <div className="flex-col-center default-gap p-6 pt-0">
          <h2 className="cursor-default text-5xl font-bold tracking-wider text-textColor-brandDark header-font-default dark:text-textColor-brand">
            {t('header-vision-aboutUs')}
          </h2>
          <Separator className="w-1/2 bg-bgColor-brandDark dark:bg-bgColor-brand" />
          <p className="text-xl text-textColor/70 dark:text-muted-foreground">
