...
const memberData = [
  {
    id: 1,
    descriptions: ['description-TrongNguyen', 'bio-TrongNguyen'],
    imageUrl:
  ...
  {
    id: 2,
    descriptions: ['description-EricNguyen', 'bio-EricNguyen'],
    imageUrl:
  ...
  {
    id: 3,
    descriptions: ['description-KhueLe', 'bio-KhueLe'],
    imageUrl:
  ...
  {
    id: 4,
    descriptions: ['description-EattleNguyen', 'bio-EattleNguyen'],
    imageUrl:
  ...
  {
    id: 5,
    descriptions: ['description-DaoNguyen', 'bio-DaoNguyen'],
    imageUrl:
  ...
  {
    id: 6,
    descriptions: ['description-KhaiHung', 'bio-KhaiHung'],
    imageUrl:
  ...
  {
    id: 2,
    descriptions: ['description-AndyNguyen', 'bio-AndyNguyen'],
    imageUrl:
...
const OrgMembers = async ({ locale }: OrgMembersProps) => {
  ...
  return (
    <div className="px-6 py-32">
      <h1 className="mb-7 text-center text-3xl font-semibold tracking-wide text-[#7f0000] md:text-4xl lg:text-5xl">
        {t('header-directors-aboutUs')}
      </h1>
      <Separator className="mb-20 w-2/3 place-self-center bg-[#7f0000] lg:w-1/2" />
